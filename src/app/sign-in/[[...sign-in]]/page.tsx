      ...
      <SignIn.Root>
        ...
        >
          ...
          <SignIn.Action
            ...
            asChild
          >
                <Button className='w-full font-bold bg-gray-700 hover:bg-gray-600'>
                        Sign In
                </Button>
          </SignIn.Action>
          <div className="rounded-xl bg-neutral-100 p-5 flex justify-evenly">
            ...
            <div className="space-y-2">
              <Clerk.Connection
                ...
                asChild
                >                
                <Button className='font-bold bg-blue-800 hover:bg-blue-700'>
                        Google 
                </Button>
              </Clerk.Connection>
            </div>
            ...
            <div className="space-y-2 ">
              <Clerk.Connection
                ...
                asChild
                >                
                <Button className=' font-bold bg-gray-700 hover:bg-gray-600'>
                         Github
                </Button>
              </Clerk.Connection>
            </div>
